...
class DecodingControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should decode a valid short code" do
    post api_v1_decode_url_path, params: { url: { short_code: @valid_short_code } }, as: :json
  ...
  test "should not decode an invalid short code" do
    post api_v1_decode_url_path, params: { url: { short_code: @invalid_short_code } }, as: :json
  ...
  test "should not decode when short code parameter is missing" do
    post api_v1_decode_url_path, params: { url: {} }, as: :json
    assert_response :unprocessable_entity
    json_response = JSON.parse(response.body)
    assert_equal "Missing parameter: url. Please provide a valid url.", json_response["message"]
  end
  ...
  #         post api_v1_encode_url_path, params: { url: { original_url: original_url, expiration_days: 30 } }, as: :json
          
  #         encode_result = JSON.parse(response.body)
  #         short_code = encode_result["data"]["short_code"]

  #         post api_v1_decode_url_path, params: { url: { short_code: short_code } }, as: :json
