...
class EncodingControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should encode a valid URL" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url, expiration_days: @expiration_days } }, as: :json
  ...
  test "should not encode an invalid URL" do
    post api_v1_encode_url_path, params: { url: { original_url: @invalid_url, expiration_days: @expiration_days } }, as: :json
  ...
  test "should encode a URL with a custom short code" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url, short_code: @short_code, expiration_days: @expiration_days } }, as: :json
    assert_response :success
    json_response = JSON.parse(response.body)
  ...
  test "should not encode a URL with an existing short code" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url, short_code: @existing_short_code, expiration_days: @expiration_days } }, as: :json
    assert_response :unprocessable_entity
    json_response = JSON.parse(response.body)
  ...
  test "should encode a URL without an expiration date" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url } }, as: :json
    assert_response :success
    json_response = JSON.parse(response.body)
  ...
  test "should not encode a URL with a short code that is too short" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url, short_code: "abc", expiration_days: @expiration_days } }, as: :json
    assert_response :unprocessable_entity
    json_response = JSON.parse(response.body)
  ...
  test "should not encode a URL with a short code that is too long" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url, short_code: "a" * 31, expiration_days: @expiration_days } }, as: :json
    assert_response :unprocessable_entity
    json_response = JSON.parse(response.body)
  ...
  test "should not encode a URL with a missing original URL parameter" do
    post api_v1_encode_url_path, params: { url: { short_code: @short_code, expiration_days: @expiration_days } }, as: :json
    assert_response :unprocessable_entity
    json_response = JSON.parse(response.body)
  ...
  test "should not encode a URL with an invalid expiration date" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url, expiration_days: "invalid" } }, as: :json
    # post api_v1_encode_url_path, params: { url: { original_url: @valid_url, expiration_days: 10 } }
    assert_response :unprocessable_entity
    json_response = JSON.parse(response.body)
  ...
  test "should not encode a URL with a short code that contains invalid characters" do
    post api_v1_encode_url_path, params: { url: { original_url: @valid_url, short_code: @invalid_short_code, expiration_days: @expiration_days } }, as: :json
    assert_response :unprocessable_entity
    json_response = JSON.parse(response.body)
